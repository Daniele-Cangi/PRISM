    ...
    <div className="editorial-theme min-h-screen bg-[#FDFDFD]">
      ...
      <header className="border-b border-[#E5E5E5] bg-white">
        <div className="editorial-wide-container py-8">
          <div className="flex flex-col md:flex-row justify-between items-end border-b-2 border-black pb-4 mb-4">
            {/* Left: Meta Data */}
            <div className="hidden md:block text-xs font-mono text-gray-500 uppercase tracking-widest space-y-1">
