...
const LandingPage = ({ onLogin }) => {
  ...
  const translations = {
    en: {
      ...
      supportText: 'Prism is an open source project. Your support helps us continue development and maintenance of this tool for information democracy.',
    ...
    da: {
      ...
      supportText: 'Prism er et open source-projekt. Din støtte hjælper os med at fortsætte udviklingen og vedligeholdelsen af dette værktøj for informationsdemokrati.',
    ...
    sv: {
      ...
      supportText: 'Prism är ett open source-projekt. Ditt stöd hjälper oss att fortsätta utvecklingen och underhållet av detta verktyg för informationsdemokrati.',
    ...
    no: {
      ...
      supportText: 'Prism er et open source-prosjekt. Din støtte hjelper oss å fortsette utviklingen og vedlikeholdet av dette verktøyet for informasjonsdemokrati.',
      sponsorGithub: 'Sponsor direkte på GitHub',
      sponsor: 'Sponsor',
    ...
    it: {
      ...
      supportText: 'Prism è un progetto open source. Il tuo supporto ci aiuta a continuare lo sviluppo e la manutenzione di questo strumento per la democrazia informativa.',
