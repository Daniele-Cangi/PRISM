...
const LandingPage = ({ onLogin }) => {
  ...
  const translations = {
    en: {
      ...
      missionText2: 'Shadow Analyzer was created to give citizens the power to see beyond the narrative. A team of experts in journalism, artificial intelligence and cybersecurity united by a common vision.',
    ...
    da: {
      ...
      missionText2: 'Shadow Analyzer blev skabt for at give borgerne magten til at se ud over narrativet. Et team af eksperter inden for journalistik, kunstig intelligens og cybersikkerhed forenet af en fælles vision.',
    ...
    sv: {
      ...
      missionText2: 'Shadow Analyzer skapades för att ge medborgarna makten att se bortom narrativet. Ett team av experter inom journalistik, artificiell intelligens och cybersäkerhet förenade av en gemensam vision.',
    ...
    no: {
      ...
      missionText2: 'Shadow Analyzer ble skapt for å gi borgerne makten til å se forbi narrativet. Et team av eksperter innen journalistikk, kunstig intelligens og cybersikkerhet forent av en felles visjon.',
